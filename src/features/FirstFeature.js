...
if (chatHistory.length === 0) {
        setIsMapActive(false); // Disable map after the first interaction
    }
  ...
  return (
    <div style={{ display: 'flex', height: '80vh' }}>
      {/* Map section (75%) */}
      <div style={{ flex: '0 0 75%', height: '80vh', zIndex: 0 }}>
      {isMapActive ? null : (
    <div style={{
        position: 'absolute',
        width: '90%',
        height: '80vh',
        backgroundColor: 'rgba(211, 211, 211, 0.7)', // Light grey overlay
        zIndex: 1000,
    ...
    <div style={{
      ...
      <p>Upgrade to premium to access the map feature!</p>
    </div>
  )}
      </div>
